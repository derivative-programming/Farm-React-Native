...
import {ReportInputPassword} from "./InputPassword";   
...
describe("InputPassword Component", () => {
  ...
  beforeEach(() => {
    render(
      ...
      <ReportInputPassword label="Test Label" name="testName"/> 
  ...
  it("when user sets prop autoFocus to true, control is autoFocused", async () => {
    render( 
      ...
      <ReportInputPassword label="Test Label" name="testName2" autoFocus={true}/> 
