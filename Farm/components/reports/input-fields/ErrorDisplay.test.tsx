...
describe("ErrorDisplay Component", () => {
  ...
  it("renders correctly when only errorCsv is provided", () => {
    ...
    expect(screen.getByText("error1")).toBeTruthy();
    expect(screen.getByText("error2")).toBeTruthy();
    expect(screen.getByText("error3")).toBeTruthy();
  });
  ...
  it("renders correctly when both errorCsv and errorArray are provided", () => {
    ...
    expect(screen.getByText("error2")).toBeTruthy();
    expect(screen.getByText("error3")).toBeTruthy();
    expect(screen.getByText("error4")).toBeTruthy();
  });
