...
import { FormInputTextArea } from './InputTextArea'; // Adjust the import path
...
describe('FormInputTextArea', () => {
  ...
  it('renders correctly', () => {
    const { getByTestId } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" />
      </Formik>
    );
  ...
  it('is not visible when isVisible is false', () => {
    const { queryByTestId } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" isVisible={false} />
      </Formik>
    );
  ...
  it('is   visible when isVisible is true', () => {
    const { queryByTestId } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" isVisible={true} />
      </Formik>
    );
  ...
  it('is disabled when disabled is true', () => {
    const { getByTestId } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" disabled={true} />
      </Formik>
    );
  ...
  it('is enabled when disabled is false', () => {
    const { getByTestId } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" disabled={false} />
      </Formik>
    );
  ...
  it('displays the correct placeholder', () => {
    const { getByPlaceholderText } = render(
      <Formik initialValues={{ text: '' }} onSubmit={mockSubmit}>
        <FormInputTextArea name="text" label="Text" placeholder="Enter your text" />
      </Formik>
    );
