...
export const ReportConnectedPacUserFlavorList: FC<ReportProps> = ({
  ...
  useEffect(() => {
    ...
    const loadAsyncData = async () => {
      ...
      const savedSortColumnName = await AsyncStorage.getItem("PacUserFlavorListSortColumnName");
      const savedSortDirection = await AsyncStorage.getItem("PacUserFlavorListSortDirection");
  ...
  const onSortChange = async (columnName: string, sortDirection: 'asc' | 'desc') => {
    ...
    await AsyncStorage.setItem("PacUserFlavorListSortColumnName", columnName);
    if(orderByDescending){
      await AsyncStorage.setItem("PacUserFlavorListSortDirection", "desc");
    }
    else
    {
      await AsyncStorage.setItem("PacUserFlavorListSortDirection", "asc");
    }
